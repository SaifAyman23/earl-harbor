...
('Port of Alexandria', 15, 1),
('Port of Barcelona', 20, 0),
('Port of New York', 25, 1),
('Port Said Harbor', 18, 0);
...
INSERT INTO Logs (log_date, description, personnel_id, vessel_id)
VALUES 
('2024-12-01', 'Routine maintenance performed.', 1, 1),
('2024-12-02', 'Cargo inspection completed.', 2, 2),
('2024-12-03', 'Shipment loaded for departure.', 3, 3),
('2024-12-04', 'Docking bay inspection completed.', 1, 1),
('2024-12-05', 'Vessel cleaned and prepared for next voyage.', 2, 2),
('2024-12-06', 'Contract signed for new shipment.', 3, 3),
('2024-12-07', 'Cargo unloaded at port.', 1, 4);
UPDATE s
SET s.status = CASE
